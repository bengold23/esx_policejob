...
function OpenPoliceActionsMenu()
	...
	'default', GetCurrentResourceName(), 'police_actions',
	{
		...
		elements = {
			...
			{label = 'Usun DNA',					value = 'removedna'},
		...
		if data.current.value == 'citizen_interaction' then
			local elements = {
				...
				--{label = 'Wiezienie', 				value = 'jail'},
				{label = 'Dodaj DNA',					value = 'dna'}
			}
		...
		elseif data.current.value == 'object_spawner' then
			...
			elseif data.current.value == 'removedna' then
...
function openJailMenu(playerid)
  local elements = {
    {label = "Cela 1",     value = 'JailPoliceStation1'},
    {label = "Cela 2",     value = 'JailPoliceStation2'},
    {label = "Cela 3",     value = 'JailPoliceStation3'},
    {label = "Stanowe",     value = 'FederalJail'},
    {label = "Wypusc",     value = 'FreePlayer'},
  }
  ESX.UI.Menu.Open(
